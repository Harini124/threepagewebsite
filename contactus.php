                                    ...
                                    <div class="row content-space content-spacing-bottom">
                                        <div class="col-6 text-center">
                                            ...
                                            <div  class="contact-us-spacing">
                                                ...
                                                <p>Srinivaspur to Kolar road,<br> Thoradevandahally ,kolar-563101</p>
                                            </div>    
                                            <div  class="contact-us-spacing">
                                                <span class="fa fa-website Website-3x"></span>
                                        ...
                                        <div  class="col-6">
                                            ...
                                            <div class="card">
                                                <form class="container top-medium-spacing bottom-medium-spacing">
                                                    ...
                                                    <div class="form-group">
                                                        <input class="form-control" type="text" type="text" placeholder="Email">
                                                    </div>
                                                    <div class="form-group">
                                                        <input class="form-control" type="text"  placeholder="subject"></textarea>
                                                    </div>
                                                    <div class="form-group">
